    ...
    def observe(self, observation, gameState):
        ...
        if (noisyDistance == None):
            ...
            for p in self.legalPositions:
                man = util.manhattanDistance(p, pacmanPosition)
                allPossible[p] = emissionModel[man]*self.beliefs[p]
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for oldPos in self.legalPositions:
            ...
            for newPos, prob in newPosDist.items():
                allPossible[newPos] += oldbeliefs*prob
        self.beliefs = allPossible
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            for pos in self.particles:
                man = util.manhattanDistance(pos, pacmanPosition)
                self.beliefs[pos] += emissionModel[man]
        self.beliefs.normalize()
